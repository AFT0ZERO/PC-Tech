...
@section('content')
    ...
    <div class="col-md-12">
        <div class="card">
            <h5 class="card-header"><strong>Edit Store</strong></h5>
            ...
            <form action="{{ route('store.update', $store->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body demo-vertical-spacing demo-only-element">
                    ...
                    <div class="form-floating form-floating-outline ">
                        <input type="text" name="name" value="{{$store->name }}" class="form-control @error('name') is-invalid @enderror" id="exampleFormControlInput1" placeholder="Name">
